...
import AddStudentCohortModal from '../../../../components/admin/addStudentModal/AddStudentModal';
          ...
          <Row className='mt-5'>
              <Col xs = '4'>
                <Card>
                  ...
                  <Card.Body>
                    <Card.Title>Front End Cohort Batch A</Card.Title>
                    <Card.Text>
                  ...
                  <Card.Body>
                    <Card.Link href="#"><Button onClick={handleShowAddStudentModal}>Add Student</Button></Card.Link>
                      ...
                      <Modal show={showAddStudentModal} onHide={handleCloseAddStudentModal}>
                          <AddStudentCohortModal  handleCloseAddStudentModal = {handleCloseAddStudentModal}/>
                      </Modal>
